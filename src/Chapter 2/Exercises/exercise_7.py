...
if len(binary_number) == 16 and binary_number[0] == '1':
    binary_number = -((1111111111111111 - int(binary_number)) + 1)

binary_number = str(binary_number)
print(binary_number)
try:
    decimal = int(binary_number[-1]) * (2 ** 0)
    decimal += int(binary_number[-2]) * (2 ** 1)
    decimal += int(binary_number[-3]) * (2 ** 2)
    decimal += int(binary_number[-4]) * (2 ** 3)
    decimal += int(binary_number[-5]) * (2 ** 4)
    decimal += int(binary_number[-6]) * (2 ** 5)
    decimal += int(binary_number[-7]) * (2 ** 6)
    decimal += int(binary_number[-8]) * (2 ** 7)
    decimal += int(binary_number[-9]) * (2 ** 8)
    decimal += int(binary_number[-10]) * (2 ** 9)
    decimal += int(binary_number[-11]) * (2 ** 10)
    decimal += int(binary_number[-12]) * (2 ** 11)
    decimal += int(binary_number[-13]) * (2 ** 12)
    decimal += int(binary_number[-14]) * (2 ** 13)
    decimal += int(binary_number[-15]) * (2 ** 14)
    decimal += int(binary_number[-16]) * (2 ** 15)
    decimal = binary_number[-17] + decimal
except IndexError:
